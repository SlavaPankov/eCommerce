...
import { LogoList } from '../../shared/LogoList';
  ...
  return (
    <Content>
      <div className={className}>
        ...
        <Link to="https://rs.school/" className={styles.logo}>
        ...
        <h3 className={styles.subtitle}>Наша команда</h3>
        <div className={styles.wrapper}>
          <DevProfile
            name="Слава"
            title="Frontend Developer"
            github="https://github.com/SlavaPankov"
            bio="Закончил НГТУ им. Р. Е. Алексеева по специальности энергетическое машиностроение. Проработал 3 года инженером-программистом. После решил сменить специальность на Веб-разработчика. Успешно закончил курс по WebLayout, JavaScript, ReactJS, native PHP от Skillbox. Также в рамках саморазвития ознакомился с VueJS. Но знаний много не бывает, поэтому решил закончить еще RSSchool. Работал frontend разработчиком в маркетинговых агентствах НЕОАналитика, Malevich. На данный момент работает разработчиком бизнес-процессов в компании IKOD."
            imageLink={Slava}></DevProfile>
          <DevProfile
            name="Катя"
            title="Junior Frontend Developer"
            github="https://github.com/katie-soft"
            bio="Катя уже не в первый раз в жизни меняет свою специальность. Она отучилась на переводчика, потом работала в HR и поняла, что иногда легче самому стать frontend-разработчиком, чем найти подходящего кандидата на эту вакансию. Параллельно с учебой в RS School работает верстальщиком в онлайн-издании. Хобби: велосипед, настольные игры."
            imageLink={Katya}></DevProfile>
          <DevProfile
            name="Лев"
            title="Junior Frontend Developer"
            github="https://github.com/Hotimpulse"
            bio="Лев начал свою карьеру как контент-менеджер/видеомонтажёр. Окончив ВУЗ по специальности Переводчик китайского языка, Лев добрался до веб разработки, и теперь познаёт тонкости продвинутого JavaScript. Похоже, Лев любит усложнять себе жизнь. В свободное от работы время Лев предпочитает бросать мяч в кольцо под чёткий хипхопчик."
            imageLink={Lev}></DevProfile>
        </div>
        <h3 className={styles.subtitle}>Наши инструменты</h3>
        <LogoList />
        <h3 className={styles.subtitle}>Работа над проектом</h3>
        <p className={styles.text}>
          Наша работа над проектом началась с настройки окружения и сборщика (Webpack), так как мы
          решили не использовать create-react-app, а пощупать все самостоятельно. Затем мы
          познакомились с API Commercetools, выбрали тематику интернет-магазина, а также его дизайн.
          В дальнейшем мы работали по спринтам. В качестве опорных точек каждого спринта проводили
          планирование с оценкой задач и ретроспективу. По итогу были реализованы следующие фичи
          интернет-магазина по продаже мебели:
        </p>
        <ul className={styles.list}>
          <li className={styles.list__item}>
            Каталог товаров <span className={styles.author}>Слава</span>
          </li>
          <li className={styles.list__item}>
            Страница регистрации пользователя <span className={styles.author}>Катя</span>
          </li>
          <li className={styles.list__item}>
            Страница логина <span className={styles.author}>Лев</span>
          </li>
          <li className={styles.list__item}>
            Поиск и фильтрация по каталогу <span className={styles.author}>Слава</span>
          </li>
          <li className={styles.list__item}>
            Карточки товаров <span className={styles.author}>Лев</span>
          </li>
          <li className={styles.list__item}>
            Раздел с данными пользователя <span className={styles.author}>Катя</span>
          </li>
          <li className={styles.list__item}>
            Корзина <span className={styles.author}>Слава</span>
          </li>
        </ul>
      </div>
    </Content>
